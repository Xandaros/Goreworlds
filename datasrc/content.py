...
image_teesplatter = Image("teesplatter", "teesplatter.png")
image_hats = Image("hats", "hats.png")
...
container.images.Add(image_teesplatter)
container.images.Add(image_hats)
...
set_teesplatter = SpriteSet("teesplatter", image_teesplatter, 8, 1)
set_hats = SpriteSet("hats", image_hats, 16, 1)
set_game = SpriteSet("game", image_game, 32, 16)
set_flag = SpriteSet("flag", image_flag, 8, 2)
set_weapons = SpriteSet("weapons", image_weapons, 32, 16)
...
container.spritesets.Add(set_teesplatter)
container.spritesets.Add(set_hats)
...
container.sprites.Add(Sprite("teesplatter01", set_teesplatter, 0,0,1,1))
container.sprites.Add(Sprite("teesplatter02", set_teesplatter, 1,0,1,1))
container.sprites.Add(Sprite("teesplatter03", set_teesplatter, 2,0,1,1))
container.sprites.Add(Sprite("teesplatter04", set_teesplatter, 3,0,1,1))
container.sprites.Add(Sprite("teesplatter05", set_teesplatter, 4,0,1,1))
...
container.sprites.Add(Sprite("hat_terrorist1", set_hats, 0,0,3,1))
container.sprites.Add(Sprite("hat_terrorist2", set_hats, 3,0,3,1))
container.sprites.Add(Sprite("hat_counterterrorist1", set_hats, 6,0,3,1))
container.sprites.Add(Sprite("hat_counterterrorist2", set_hats, 9,0,3,1))
container.sprites.Add(Sprite("hat_counterterrorist3", set_hats, 12,0,3,1))
